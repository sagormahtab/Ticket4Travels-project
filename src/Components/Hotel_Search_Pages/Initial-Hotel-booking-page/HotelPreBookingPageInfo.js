            ...
            <div className="container mt-5 mb-5">
                <div className="row">
                    <div className="col-md-12 col-sm-12 col-12">
                        <Card className="hotelprebookCard1">
                ...
                <div className="row mt-5">
                    <div className="col-md-10 col-12 text-left">
                        ...
                        <Card size="small" title="Name" extra={<a href="hotelPre_Booking">Flight Details</a>} className="hotelprebookCard2">
                    ...
                    <div className="col-md-2 col-12 se_div">
                        ...
                        <Card size="small" title="Additional Information" extra={<a href="hotelPre_Booking">Details</a>} style={{ width: 300 }}>
