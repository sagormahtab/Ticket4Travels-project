          ...
          <ul class="nav nav-pills ">
            <li class="nav-item dropdown px-4">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item mt-2" href="/"><img src={Drp1} width="20px" height="20px" alt="" className="img-fluid"></img> Flights</a>
                <a class="dropdown-item mt-2" href="/">Flights + Hotels</a>
                <a class="dropdown-item mt-2" href="/"> <img src={Drp3} width="20px" height="20px" alt="" className="img-fluid"></img> Trains</a>
                <a class="dropdown-item mt-2" href="/">JR Pass</a>
                <a class="dropdown-item mt-2" href="/"> <img src={Drp5} width="20px" height="20px" alt="" className="img-fluid"></img> Bus & Shuttle</a>
            ...
            <li class="nav-item dropdown px-4">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item mt-2" href="/"> <img src={Drp8} width="20px" height="20px" alt="" className="img-fluid"></img> Hotels</a>
                <a class="dropdown-item mt-2" href="/">Flights + Hotels</a>
              </div>
            </li>
