        ...
        <div className="container mt-5 mb-5">
          <div className="row">
            <div className="col-md-12 col-sm-12 col-12">
              <Card className="busprebookCard1">
                <h3 className="text-left">
                  Flight from Name of the destination to Name of the destination
                </h3>
                  ...
                  <div className="col-md-6 col-12 ml-5">
                    <p>
                      ...
                      <img
                        ...
                        width="20px"
                        height="20px"
                        className="ml-5 mr-5 img-fluid"
                        alt=""
                      ></img>{" "}
                      Name <span className="ml-3"> | </span> 13sep 2021
                    </p>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-6 col-12 margin_div mt-4">
                    <p>
                      {" "}
                      1 Adult <span className="ml-3 mr-3"> | </span> Economy
                    </p>
                  </div>
                </div>
              </Card>
          ...
          <div className="row mt-5">
            <div className="col-md-10 text-left">
              <Card
                size="small"
                title="Name"
                extra={<a href="busPre_Booking">Flight Details</a>}
                className="busprebookCard2"
              >
                <div className="pointing_div">
                  <img
                    src={pointing}
                    width="20px"
                    height="20px"
            ...
            <div className="col-md-2 se_div">
              <Card
                ...
                extra={<a href="busPre_Booking">Details</a>}
                style={{ width: 300 }}
              >
                ...
                <div className="text-left mt-4">
                  <p>
                    <img
                      ...
                      className="img-fluid"
                    ></img>
                    <span className="green_div">Refundable</span>
                  </p>
                  <p>
                    <img
                      src={tik}
