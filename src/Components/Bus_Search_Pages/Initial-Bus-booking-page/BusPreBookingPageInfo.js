            ...
            <div className="container mt-5 mb-5">
                ...
                <div className="row mt-5">
                    <div className="col-md-10 text-left">
                        ...
                        <Card size="small" title="Name" extra={<a href="busPre_Booking">Flight Details</a>} className="busprebookCard2">
                    ...
                    <div className="col-md-2 se_div">
                        ...
                        <Card size="small" title="Additional Information" extra={<a href="busPre_Booking">Details</a>} style={{ width:300 }}>
