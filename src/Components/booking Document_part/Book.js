        ...
        <div>
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <img src={pic1} height="250px" width="230px"></img>
                    </div>
                    <div className="col-md-10 text_part">
                ...
                <div className="container">
                    ...
                    <p className="ml-5">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has</p>
                        </div>
                        <div className="col-md-2 pic">
                    <img src={pic2} height="250px" width="230px"></img>
                    </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-2 ">
                    <img src={pic3} height="250px" width="200px"></img>
                    </div>
                    <div className="col-md-10 text_part">
                    <h5>Various payment</h5>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has</p>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-10 text_part2 text-right">
                        <h5 className="text">Various payment</h5>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has</p>
                        </div>
                        <div className="col-md-2 pic">
                    <img src={pic4} height="250px" width="230px"></img>
                    </div>
                    </div>
                </div>
            </div>
