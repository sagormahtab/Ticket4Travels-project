        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-10 col-8 mt-5">
              ...
              <p>
                Easy and hassle free payment methods available in Tickets4Travel
                from ATM Transfer, Credit Card, to Internet Banking.{" "}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mt-5">
          <div className="row">
            <div className="col-md-10 col-8 mt-5 special-dis-text">
              ...
              <p>
                Lucrative discounts and hotels offers for our customers,
                newsletter subscribers and Tickets4Travel members.
              </p>
            </div>
        ...
        <div className="container mt-5">
          <div className="row">
            ...
            <div className="col-md-10 col-8 text_part">
              ...
              <p>
                From budget friendly to official price offers in hotels and
                transportation tickets guaranteed.{" "}
              </p>
            </div>
          </div>
        </div>
