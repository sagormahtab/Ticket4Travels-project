              ...
              <div className="text-center mt-4">
                <div className="drop2 px-5">
                  ...
                  <Dropdown overlay={menu} trigger={['click']} className="pr-5">
                    <a className="ant-dropdown-link" href onClick={e => e.preventDefault()}>Flight Price Alert<DownOutlined />
                    </a>
                  </Dropdown>
                  ...
                  <Dropdown overlay={menu} trigger={['click']} className="pr-5">
                    <a className="ant-dropdown-link" href onClick={e => e.preventDefault()}>Saved List<DownOutlined />
                    </a>
                  </Dropdown>
                  ...
                  <Dropdown overlay={menu} trigger={['click']} className="pr-5">
                    <a className="ant-dropdown-link" href onClick={e => e.preventDefault()}>Easy Reschedule<DownOutlined />
                    </a>
                  </Dropdown>
                  ...
                  <Dropdown overlay={menu} trigger={['click']} className="pr-5">
                    <a className="ant-dropdown-link" href onClick={e => e.preventDefault()}>Passanger Quick Pic<DownOutlined />
                    </a>
                  </Dropdown>
                  ...
                  <Dropdown overlay={menu} trigger={['click']} className="pr-5">
                    <a className="ant-dropdown-link" href onClick={e => e.preventDefault()}>Stay Guarante<DownOutlined />
                    </a>
                  </Dropdown>
