        ...
        <div className="col-md-12">
          <Card>
            <CardContent>
              ...
              <p className="mt-5">
                Tickets4Travel is committed to ensuring that the app is as
                ...
                you exactly what you’re paying for. The Tickets4Travel app
                stores and processes personal data that you have provided to us,
                in order to provide our Service. It’s your responsibility to
                ...
                mean that the Tickets4Travel app won’t work properly or at all.
              </p>
              ...
              <p className="mt-5">
                Google Play Services Facebook You should be aware that there are
                certain things that Tickets4Travel will not take responsibility
                ...
                provided by your mobile network provider, but Tickets4Travel
              ...
              <p className="mt-5">
                Along the same lines, Tickets4Travel cannot always take
                ...
                and you can’t turn it on to avail the Service, Tickets4Travel
                cannot accept responsibility. With respect to Tickets4Travel’s
                responsibility for your use of the app, when you’re using the
                app, it’s important to bear in mind that although we endeavour
                to ensure that it is updated and correct at all times, we do
                rely on third parties to provide information to us so that we
                can make it available to you. Tickets4Travel accepts no
              ...
              <p className="mt-5">
                ...
                currently available on Android – the requirements for system(and
                for any additional systems we decide to extend the availability
                of the app to) may change, and you’ll need to download the
                updates if you want to keep using the app. Tickets4Travel does
                not promise that it will always update the app so that it is
                relevant to you and/or works with the Android version that you
                have installed on your device. However, you promise to always
                accept updates to the application when offered to you, We may
                also wish to stop providing the app, and may terminate use of it
                at any time without giving notice of termination to you. Unless
              ...
              <h3 className="mt-5">Changes to This Terms and Conditions</h3>
              <p className="mt-3">
                ...
                are effective as of 2021-02-03
              </p>
              <h3 className="mt-5">Contact Us</h3>
              <p className="mt-3">If you have any questions or suggestions about our Terms and Conditions, do not hesitate to contact us at contact@tickets4travel.com.</p>
