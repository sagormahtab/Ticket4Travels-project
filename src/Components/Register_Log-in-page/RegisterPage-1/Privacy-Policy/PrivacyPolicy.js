        ...
        <div className="col-md-12">
          <Card>
            <CardContent>
              ...
              <p className="mt-5">
                Tickets4Travel built the Tickets4Travel app as a Commercial app.
                This SERVICE is provided by Tickets4Travel and is intended for
                use as is.
              </p>
              <p className="mt-5">
              ...
              <p className="mt-5">
                ...
                Tickets4Travel unless otherwise defined in this Privacy Policy.
              </p>
              ...
              <h3 className="mt-4">Google Play Services Facebook Log Data</h3>
              <p className="mt-5">
              ...
              <p className="mt-5">
                ...
                this Service that these third parties have access to your
              ...
              <h3 className="mt-4">Links to Other Sites</h3>
              <p className="mt-5">
              ...
              <p className="mt-5">This policy is effective as of 2021-02-03</p>
