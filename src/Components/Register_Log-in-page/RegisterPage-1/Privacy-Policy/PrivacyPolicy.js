const PrivacyPolicy = () => {
  return (
    <div className="container">
      <div className="row">
        <div className="col-md-12 ml-4 mr-4">
          <h2 className="mt-3 mb-3">Privacy Policy for Tickets4Travel Ltd.</h2>
          ...
          <p>
            ...
            recorded by Tickets4Travel and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in Tickets4Travel. This policy is
            not applicable to any information collected offline or via channels
            other than this website. Consent
          </p>
          ...
          <h3>Understand and analyze how you use our website</h3>
          ...
          <p>
            Like any other website, Tickets4Travel uses 'cookies'. These cookies
          ...
          <p>
            ...
            advertising partners of Tickets4Travel.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Tickets4Travel,
          ...
          <p>
            Note that Tickets4Travel has no access to or control over these
