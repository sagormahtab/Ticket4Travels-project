                ...
                <div className="container mt-5">
                    <div className="row">
                        ...
                        <div className="col-sm-4 col-md-4 col-12 mt-5">
                            <img src={hotelPic1} alt="hotelPic" height="210px" width="280px" className="img-fluid"></img>
                        </div>
                        <div className=" col-sm-4 col-md-4 col-12 mt-5">
                            <img src={hotelPic2} alt="hotelPic2" height="210px" width="280px" className="img-fluid"></img>
                        </div>
                    </div>
                </div>
