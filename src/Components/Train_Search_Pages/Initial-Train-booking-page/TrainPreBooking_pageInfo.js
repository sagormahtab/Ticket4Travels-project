            ...
            <div className="container mt-5 mb-5">
                ...
                <div className="row mt-5">
                    <div className="col-md-10 text-left">
                        ...
                        <Card size="small" title="Name" extra={<a href="#">Flight Details</a>} style={{ width: 600 }}>
                            <div className="pointing_div"><img src={pointing} width="20px" height="20px"></img><span className="ml-5">Name</span></div>
                            ...
                            <div className="row">
                                <div className="col-md-4">18:00</div>
                                <div className="col-md-4">21:20</div>
                                <div className="col-md-4">01h, 50m</div>
                            </div>
                            <div className="pointing2"><img src={pointing} width="20px" height="20px"></img></div>
                            <div className="row mt-3">
                                <div className="col-md-4">Name</div>
                                <div className="col-md-4">Nmae</div>
                                <div className="col-md-4"><Radio>Direct</Radio></div>
                            </div>
                        </Card>
                    </div>
                    <div className="col-md-2 se_div">
                        ...
                        <Card size="small" title="Price Details"  style={{ width:300 }}>
                            ...
                            <div className="row mt-3">
                                <div className="col-md-6">Price you pay</div>
                                <div className="col-md-6">Amount</div>
                            </div>
                        </Card>
...
export default TrainPreBooking_pageInfo
