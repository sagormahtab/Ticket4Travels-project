...
import "../Initial-Train-booking-page/trainPreBook.css"
import { Card } from 'antd';
import pln1 from "../Initial-Train-booking-page/images/plane.png"
import Arr1 from "../Initial-Train-booking-page/images/next.png"
import { Radio } from 'antd';
import pointing from "../Initial-Train-booking-page/images/pointing.png"
import nt from "../Initial-Train-booking-page/images/next.png"
...
function TrainPreBookingPageInfo() {
    ...
    return (
        <div>
            <div className="container mt-5 mb-5">
                    ...
                    <div className="row">
                        <div className="col-md-12 col-12"> <Card  className="trainprebookCard1">
                ...
                <div className="row mt-5">
                    <div className="col-md-10 col-12 text-left">
                        ...
                        <Card size="small" title="Name" extra={<a href="trainPre_booking">Flight Details</a>}  className="trainprebookCard2">
                    ...
                    <div className="col-md-2 col-10 se_div">

                        <Card size="small" title="Additional Information" extra={<a href="trainPre_booking">Details</a>} style={{ width:300 }}>
                            ...
                            <div className="text-left mt-4">
                                ...
                                <p><img src={tik} width="20px" height="20px" className="img-fluid" alt=""></img><span className="green_div">Refundable</span></p>
                            </div>
                        </Card>
...
export default TrainPreBookingPageInfo
